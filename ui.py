...
class WinGUI(Tk):
    def __init__(self):
        ...
        # notebook0
        self.tk_label_frame_func_1 = self.__tk_label_frame_func_1(
            self.tk_tabs_notebook_0
        )
        self.tk_label_lable_amount_1 = self.__tk_label_lable_amount_func_1(
            self.tk_label_frame_func_1
        )
        self.tk_input_input_amount_1 = self.__tk_input_input_amount_func_1(
            self.tk_label_frame_func_1
        )
        self.tk_button_button_func_1 = self.__tk_button_button_func_1(
            self.tk_label_frame_func_1
        )

        self.tk_label_frame_func_3 = self.__tk_label_frame_func_3(
            self.tk_tabs_notebook_0
        )
        self.tk_label_lable_amount_3 = self.__tk_label_lable_amount_func_3(
            self.tk_label_frame_func_3
        )
        self.tk_input_input_amount_3 = self.__tk_input_input_amount_func_3(
            self.tk_label_frame_func_3
        )
        self.tk_button_button_func_3 = self.__tk_button_button_func_3(
            self.tk_label_frame_func_3
        )

        # notebook1
        self.tk_label_frame_func_2 = self.__tk_label_frame_func_2(
            self.tk_tabs_notebook_1
        )
        self.tk_check_button_func_1 = self.__tk_check_button_func_1(
            self.tk_label_frame_func_2
        )
        self.tk_check_button_func_2 = self.__tk_check_button_func_2(
            self.tk_label_frame_func_2
        )
        self.tk_check_button_func_3 = self.__tk_check_button_func_3(
            self.tk_label_frame_func_2
        )
        self.tk_button_button_func_2 = self.__tk_button_button_func_2(
            self.tk_label_frame_func_2
        )

        self.tk_label_frame_func_4 = self.__tk_label_frame_func_4(
            self.tk_tabs_notebook_1
        )
        self.tk_button_button_func_4 = self.__tk_button_button_func_4(
            self.tk_label_frame_func_4
        )
    ...
    def __tk_select_box_select_win(self, parent):
        ...
        cb.place(
            ...
            y=20 * self.scaleFactor,
            width=560 * self.scaleFactor,
            height=30 * self.scaleFactor,
        )
        cb.set("选择程序")
        return cb
    ...
    def __tk_tabs_notebook(self, parent):
        ...
        frame.place(
            x=20 * self.scaleFactor,
            y=75 * self.scaleFactor,
            width=560 * self.scaleFactor,
            height=305 * self.scaleFactor,
        )
        return frame
    ...
    def __tk_label_lable_amount_func_1(self, parent):
        ...
        label.place(
            x=0 * self.scaleFactor,
            y=10 * self.scaleFactor,
            width=70 * self.scaleFactor,
            height=30 * self.scaleFactor,
        )
        return label
    ...
    def __tk_button_button_func_1(self, parent):
        ...
        btn.place(
            x=460 * self.scaleFactor,
            y=10 * self.scaleFactor,
            width=60 * self.scaleFactor,
            height=30 * self.scaleFactor,
        )
        return btn
